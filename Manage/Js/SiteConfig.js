...
$(document).ready(function () {
    ...
    if ((_sysName.indexOf("nutrilon")) >= 0) {
        ...
        InterfaceUrl = "http://59357538.cmnapp.taegrid.taobao.com/d/AjaxItf";
        // http://cmnapp-0.taegrid.taobao.com/d/AjaxItf
    }
        ...
        CmnAjax.Cfg.ProxyUrl = "";
        InterfaceUrl = "/Cg/Itf/Php/AjaxItf.php";
    }
        ...
        CmnAjax.Cfg.ProxyUrl = "";
        InterfaceUrl = Cmn.Func.GetRoot()+"Itf/Php/AjaxItf.php";
    }
    ...
    if ((_url + "").indexOf("Default.html") >= 0) {
        ...
        //隐藏验证码
        if (!IsShowSecurityCode) {
            $(".jscCode").css({ background: "#fff",width: "300px",height: "200px",left:"-=3" });
            $(".jscCode").find(".jscCodeContent").hide();
            $(".jscLoginBtn").css({ top: "-=110px" });
            $(".jscAgree").hide();
        }
        ...
        CmnMis.Frame.InitLogin(InterfaceUrl, function (param) {
            ...
            if ($("input" + _misSelector.LoginSecurityCode).val() == _securityCode.html() || !IsShowSecurityCode) {
                if (data.IsSuccess == "1") {
